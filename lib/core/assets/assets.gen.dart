...
class $AssetsImagesGen {
  ...
  List<AssetGenImage> get values =>
      [bgHome, failed, imgMyLocation, profile, seeLocation, success];
}

class $AssetsIconsLogoGen {
  const $AssetsIconsLogoGen();

  /// File path: assets/icons/logo/logo_only_primary.svg
  SvgGenImage get logoOnlyPrimary =>
      const SvgGenImage('assets/icons/logo/logo_only_primary.svg');

  /// File path: assets/icons/logo/logo_only_white.svg
  SvgGenImage get logoOnlyWhite =>
      const SvgGenImage('assets/icons/logo/logo_only_white.svg');

  /// File path: assets/icons/logo/logo_primary.svg
  SvgGenImage get logoPrimary =>
      const SvgGenImage('assets/icons/logo/logo_primary.svg');

  /// File path: assets/icons/logo/logo_white.svg
  SvgGenImage get logoWhite =>
      const SvgGenImage('assets/icons/logo/logo_white.svg');

  /// List of all assets
  List<SvgGenImage> get values =>
      [logoOnlyPrimary, logoOnlyWhite, logoPrimary, logoWhite];
}
